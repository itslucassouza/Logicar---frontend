    ...
    return (
      <li key={index}>
        <a
          ...
          className={[
            "group m-0 flex text-white cursor-pointer rounded-lg items-center justify-between h-12 py-0 pr-3 mb-1 focus:outline-none",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative h-screen overflow-hidden bg-[#0A0D14] `}
      >
